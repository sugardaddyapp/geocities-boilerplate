pub struct Theme {
    pub name:           &'static str,
    pub bg:             &'static str,
    pub bg_pattern:     &'static str,
    pub bg_size:        &'static str,
    ...
    pub border_dark:    &'static str,
    pub panel_bg:       &'static str,
    pub panel_border:   &'static str,
    pub counter_bg:     &'static str,
    pub counter_text:   &'static str,
    pub table_border:   &'static str,
    pub table_header_bg:&'static str,
    pub glow_color:     &'static str,
    pub nav_active_bg:  &'static str,
    pub nav_active_text:&'static str,
}

pub const NEON: Theme = Theme {
    name: "Neon", bg: "#000000",
    bg_pattern: "radial-gradient(circle, #001100 1px, transparent 1px)",
    ...
    nav_active_bg: "#00FF00", nav_active_text: "#000000",
};

pub const SPACE: Theme = Theme {
    name: "Space", bg: "#000033",
    bg_pattern: "radial-gradient(circle, #ffffff 1px, transparent 1px)",
    ...
    nav_active_bg: "#FFDD00", nav_active_text: "#000033",
};

pub const CANDY: Theme = Theme {
    name: "Candy", bg: "#FF69B4",
    bg_pattern: "repeating-linear-gradient(45deg, #FF1493 0px, #FF1493 2px, #FF69B4 2px, #FF69B4 20px)",
    ...
    nav_active_bg: "#FFFF00", nav_active_text: "#CC0066",
};

pub const FOREST: Theme = Theme {
    name: "Forest", bg: "#003300",
    bg_pattern: "repeating-linear-gradient(0deg, #002200 0px, #002200 1px, #003300 1px, #003300 20px)",
    ...
    nav_active_bg: "#FFDD00", nav_active_text: "#002200",
};

pub const WINDOWS: Theme = Theme {
    name: "Windows 95", bg: "#008080",
    bg_pattern: "none", bg_size: "auto",
    ...
    nav_active_bg: "#000080", nav_active_text: "#FFFFFF",
};
